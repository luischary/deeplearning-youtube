...
if __name__ == "__main__":
    ...
    df = pd.read_parquet("data/wiki_en/wiki_en_sample.pq")
    treino = (
        df[df.split == "train"].sample(500_000, replace=False).reset_index(drop=True)
    )
    ...
    metadados_valid.to_parquet("data/wiki_en/sample_validacao_tokenized.pq")
    ...
    metadados_train.to_parquet("data/wiki_en/sample_treino_tokenized.pq")
